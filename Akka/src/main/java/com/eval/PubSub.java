...
public class PubSub {
	...
	public static void main(String[] args) {
		...
		broker.tell(Props.create(Worker.class),ActorRef.noSender());
		publisher.tell(new InitMsg(broker),ActorRef.noSender());
		subscriber.tell(new InitMsg(broker),ActorRef.noSender());
